...
Bem-vindo ao repositório do projeto de gerenciamento do processo seletivo da Universidade Stark. Este repositório contém o código-fonte e a documentação necessários para implementar e manter o sistema de seleção de candidatos para os cursos oferecidos pela universidade.
